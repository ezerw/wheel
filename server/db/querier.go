...
type Querier interface {
	...
	GetTurnByDate(ctx context.Context, arg GetTurnByDateParams) (Turn, error)
	...
	ListTurnsWithBothDates(ctx context.Context, arg ListTurnsWithBothDatesParams) ([]Turn, error)
	ListTurnsWithDateFrom(ctx context.Context, arg ListTurnsWithDateFromParams) ([]Turn, error)
	ListTurnsWithDateTo(ctx context.Context, arg ListTurnsWithDateToParams) ([]Turn, error)
